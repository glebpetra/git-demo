...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCustomSceneENDCLASS_t qt_meta_stringdata_CLASSCustomSceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 22),  // "signalTargetCoordinate"
        QT_MOC_LITERAL(35, 0),  // ""
        QT_MOC_LITERAL(36, 5)   // "point"
    },
    "CustomScene",
    "signalTargetCoordinate",
    "",
...
void CustomScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CustomScene::signalTargetCoordinate; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
